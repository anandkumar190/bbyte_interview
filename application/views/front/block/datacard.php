      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row">
		  ...
		  {system_message}    
            ...
            <?php echo form_open_multipart('datacard/proceedRecharge', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              <div class="mb-3">
                <div class="custom-control custom-radio custom-control-inline">
                  <input id="prepaid" name="recharge_type" value="1" class="custom-control-input" checked="" type="radio">
                  <label class="custom-control-label" for="prepaid"><b>Prepaid</b></label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  <input id="postpaid" name="recharge_type" value="2" class="custom-control-input" type="radio">
              ...
              <div class="form-group">
                <input type="text" class="form-control" data-bv-field="number" id="cardNumber" name="cardNumber" placeholder="Enter Your DataCard Number">
          ...
          <div class="col-lg-8">
            <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
              <div class="item"><a href="#"><img class="img-fluid" src="{site_url}skin/front/images/slider/banner-2.jpg" alt="banner 3" /></a></div>
              <div class="item"><a href="#"><img class="img-fluid" src="{site_url}skin/front/images/slider/banner-1.jpg" alt="banner 4" /></a></div>
            </div>
          </div><!-- Slideshow end -->
