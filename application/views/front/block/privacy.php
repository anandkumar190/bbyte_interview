        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <ul class="breadcrumb justify-content-start justify-content-md-end mb-0">
              <li><a href="{site_url}home">Home</a> / Privacy Policy</li>
            </ul>
          </div>
        </div>
      </div>
...
<p>By mere use of the Website, you expressly consent to our use and disclosure of your personal information in accordance with this Privacy Policy. This Privacy Policy is incorporated into and subject to the Terms of Use.
        ...
        <h2 class="text-6">1. Collection of Personally Identifiable Information and other Information</h2>
...
<p>If you transact with us, we collect some additional information, such as a billing address, a credit / debit card number and a credit / debit card expiration date and/ or other payment instrument details and tracking information from cheques or any other modes of payment</p>
<p>If you choose to post messages on our message boards, chat rooms or other message areas or leave feedback, we will collect such information you provide to us. We retain this information as necessary to resolve disputes, provide customer support and troubleshoot problems as permitted by law.</p>
...
<h2 class="text-6">2. Use of Demographic / Profile Data / Your Information</h2>
...
<h2 class="text-6">3. Sharing of personal information</h2>
...
<h2 class="text-6">4. Links to Other Sites</h2>
        <p>Our Website links to other websites that may collect personally identifiable information about you. cranesmart.in is not responsible for the privacy practices or the content of those linked websites.
</p>	

<h2 class="text-6">5. Security Precautions</h2>
        <p>Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.
</p>
<h2 class="text-6">6. Choice / Opt-Out</h2>
...
<p>If you want to remove your contact information from all cranesmart.in lists and newsletters, please visit <br /> http://www.cranesmart.in/unsubscribe.php

</p>	
<h2 class="text-6">7. Advertisements on cranesmart.in</h2>
...
<h2 class="text-6">8. Your Consent</h2>
...
<h2 class="text-6">9. Grievance Officer</h2>
...
Mr.Samad Naim, Cranesbill Tradelink Private Limited ------------------------------------------------------------------------------------------------------------------,India <br />Phone: +91 0000000000 <br /> Email  info@cranespay.com <br />
Time: Mon – Sat (10:00 AM – 6:00 PM)

</p>
<h2 class="text-6">10. Questions?</h2>
        <p>Questions regarding this statement should be directed to the following address <br /> info@cranespay.com 
</p>		
