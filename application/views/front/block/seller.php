    ...
    Forgot Password
          ...
          <div class="tab-pane fade <?php if(set_value('tab') == 2){ ?> show active <?php } ?>" id="signupPage" role="tabpanel" aria-labelledby="signup-page-tab">
			...
			<input type="hidden" name="tab" value="2" />
				...
				<div class="row">
					<div class="col-sm-12">
						<h4>Document<small>(Image should be jpeg,jpg,png)</small></h4>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="file" class="form-control" name="address_proof"  onchange="return ValidateFileUpload1()" required="" id="fileChooser1">
					...
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="file" class="form-control" name="pan_card" onchange="return ValidateFileUpload2()" required="" id="fileChooser2">
