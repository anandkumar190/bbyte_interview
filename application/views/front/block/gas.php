      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row">
		  ...
		  {system_message}    
            ...
            <?php echo form_open_multipart('gas/proceedRecharge', array('id' => 'electricity-form')); ?>
              <div class="form-group">
                <select class="custom-select" name="operator" id="gasOperator">
              ...
              <div class="form-group">
                <input type="text" class="form-control" data-bv-field="number" id="gas_account_number" name="account_number" placeholder="BP Number">
