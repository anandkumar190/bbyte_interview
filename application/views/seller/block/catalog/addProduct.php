						...
						<div class="col-md-12">
							<div class="box box-success">                    
								<div class="box-body">
									...
									<input type="file" style="display:none;" class="images" id="main_images" name="main_images" required="">
									...
									<div class="row">
										<div class="col-md-2 other-img">
											...
											<input type="file" style="display:none;" class="images" id="main_images2" name="main_images2" required="">
										...
										<div class="col-md-2 other-img">
											...
											<input type="file" style="display:none;" class="images" id="main_images3" name="main_images3" required="">
