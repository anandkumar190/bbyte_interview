<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}admin/member/memberList" class="btn btn-secondary">View All</a>
                <a href="{site_url}admin/member/addMember" class="btn btn-primary">+Add Member</a>
                <a href="{site_url}admin/member/addManulMember" class="btn btn-primary">+Add Manual Member</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
