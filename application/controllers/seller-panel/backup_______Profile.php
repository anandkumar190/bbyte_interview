...
class Profile extends CI_Controller{
    ...
    public function updateProfile() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Az->redirect('seller/profile/profile', 'system_message_error',lang('REQUIRED_ALL_FEILDS'));
        } 
        else {
            ...
            $this->Az->redirect('seller/profile/profile', 'system_message_error',lang('PROFILE_UPDATE_SUCCESSFULLY'));
