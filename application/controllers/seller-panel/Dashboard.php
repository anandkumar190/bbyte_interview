...
class Dashboard extends CI_Controller{
	...
	public function update_admin() {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('seller/Dashboard/', 'system_message_error',lang('USER_UPDATE_SUCCESSFULLY'));
	...
	public function logOut() {
        $this->Login_model->sellerLogout();
        $this->Az->redirect('seller', 'system_message_error', lang('LOGOUT_SUCCESS'));
    }
