        ...
        $.SyntaxHighlighter = {
            ...
            load: function(){
                ...
                if ( !SyntaxHighlighter.loaded() ) {
                    $.appendScript(prettifyBaseUrl+'/lib/prettify.js');
                    $.appendStylesheet(baseUrl+'/prettify.css');
                    $.appendStylesheet(baseUrl+'/prettify/style.css');
                    $.each(themes,function(i,theme){
                        $.appendStylesheet(baseUrl+'/prettify/theme-'+theme+'.css');
                    });
                    if ( $.browser.msie ) {
                        $.appendStylesheet(baseUrl+'/prettify/ie.css');
                    }
